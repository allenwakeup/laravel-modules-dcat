        ...
        <form method="post" action="{{$action}}" id="scaffold" pjax-container>
            ...
            <div class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div for="inputModuleName"  class="col-sm-1 control-label text-capitalize">
                    ...
                    <span class="help-block " id="module-name-help" style="margin-left:150px;display: none">
                        <i class="fa fa-info"></i>&nbsp; Module name can't be empty!
                    </span>
